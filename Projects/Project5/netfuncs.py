...
def find_router_for_ip(routers, ip):
    ...
    return: None
    """
    # Iterate through the routers dictionary, comparing each IP address to the given IP address
...
def my_tests():
    ...
    print(ipv4_to_value("192.10.54.81"))
    print(value_to_ipv4(3221894737))
    print(get_subnet_mask_value("/16"))
    print(ips_same_subnet("10.23.121.17", "10.23.121.225", "/23")) # should be true
    print(ips_same_subnet("10.23.230.22", "10.24.121.225", "/16")) # should be false
    routers = {"1.2.3.1": {"netmask": "/24"}, "1.2.4.1": {"netmask": "/24"}}
    ip = "1.2.3.5"
